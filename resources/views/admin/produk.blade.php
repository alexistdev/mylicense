            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{route('admin.addproduk')}}"><button class="btn btn-sm btn-primary">Tambah</button></a>
                    </div>
                </div>
                <div class="card-body">
                    <table id="tabelKategori" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-center">Diperbaharui</th>
        ...
        $(function () {
            $('#tabelKategori').DataTable({
                ...
                columns: [
                    ...
                    {data: 'kategori.name', class: 'text-center'},
                    {data: 'price', class: 'text-right',
                        render: $.fn.dataTable.render.number( ',', '.', 0, 'Rp' )
                    },
                    {data: 'created_at', class: 'text-center',width: '15%'},
                    {data: 'updated_at', class: 'text-center',width: '15%'},
